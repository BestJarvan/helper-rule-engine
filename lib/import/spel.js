...
var convertArg = function convertArg(spel, conv, config, meta, parentSpel) {
  ...
  if (spel.type == "compound") {
    ...
    // todo: get from conv
    var funcToOpMap = (_funcToOpMap = {}, (0, _defineProperty2["default"])(_funcToOpMap, ".contains", "like"), (0, _defineProperty2["default"])(_funcToOpMap, ".startsWith", "starts_with"), (0, _defineProperty2["default"])(_funcToOpMap, ".endsWith", "ends_with"), (0, _defineProperty2["default"])(_funcToOpMap, "$contains", "select_any_in"), (0, _defineProperty2["default"])(_funcToOpMap, ".equals", "multiselect_equals"), (0, _defineProperty2["default"])(_funcToOpMap, ".include", "multiselect_include"), (0, _defineProperty2["default"])(_funcToOpMap, "CollectionUtils.containsAny()", "multiselect_contains"), _funcToOpMap);
